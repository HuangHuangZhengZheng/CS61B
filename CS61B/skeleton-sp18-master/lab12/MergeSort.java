...
public class MergeSort {
    ...
    private static <Item extends Comparable> Queue<Queue<Item>>
        ...
        return queues; // i do not really understand why write this function?
    }
    ...
    public static <Item extends Comparable> Queue<Item> mergeSort(
        ...
        Queue<Item> sortedSecondHalf = mergeSort(secondHalf);


        return mergeSortedQueues(sortedFirstHalf, sortedSecondHalf);
    }
